...
/*                                                        ::::::::::::::::::::       +#+    +#+     +#+     +#+            */
/*                                                        ::::::::::::::::::::       #+#    #+#     #+#     #+#    #+#     */
/*     Update: 2022/12/19 12:18:02 by branlyst            ::::::::::::::::::::        ########      ###      ######## .fr  */
/*                                                                                                                         */
/* *********************************************************************************************************************** */
...
const parseExamsLine = (line: string, type: 'médian' | 'final'): Exam | undefined => {
    const match = line.match(
        /([A-Z0-9]{4})[\s,:le]*\s*([0-9]{2})\/([0-9]{2})\/([0-9]{4})\s*de\s*([0-9]{2}:[0-9]{2})\s*à\s*([0-9]{2}:[0-9]{2})[\s,:]*([0-9()A-Za-z\s]*[0-9()A-Za-z])[\s,:]*(place\s*[0-9]*)/
    )
    if (match?.length) {
